...
CREATE TABLE `jugadas` (
  ...
  CONSTRAINT `Pregunta` FOREIGN KEY (`Pregunta`) REFERENCES `preguntas` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `Sala` FOREIGN KEY (`Sala`) REFERENCES `salasdejuegos` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
